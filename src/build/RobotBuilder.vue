...
<script>
  ...
  export default {
    ...
    methods:{
      fetchRobots() {
        this.cart = RobotAPI.getRobotsList();
      },
      addToCart() {
        RobotAPI.addRobot(this.selectedRobot);
        this.cart = RobotAPI.getRobotsList();

        const  robot = this.selectedRobot;
        const koszt =robot.head.cost +
          robot.leftArm.cost +
          robot.torso.cost +
          robot.rightArm.cost +
          robot.base.cost;
        this.$store.commit('addRobotToCart', Object.assign({},
          this.selectedRobot,{koszt}));
        this.addedToCart = true;
      },
      removeFromCart(){
        RobotAPI.removeRobot();
        this.cart = RobotAPI.getRobotsList();
      }
